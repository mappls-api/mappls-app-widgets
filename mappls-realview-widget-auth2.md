...
Before using our SDKs or APIs in your solution, please ensure that the related access is enabled in the [Mappls DEV Console](https://auth.mappls.com/console). 

Mappls SDKs & APIs follow OAuth2 based security.
Access Tokens can be generated using Token Generation API.
To know more on how to create your access tokens, please use our authorization API URL. More details available [here](https://auth.mappls.com/console).<br>
...
```html
<iframe
        src="https://pano.mappls.com/realview_widget/jq5qn8?access_token=<Token>&minDistance=1&maxDistance=500&arrow=true&map=true&zoomControls=true&controls=true&mapWidth=200&mapHeight=200"
...
### Demo Link
[https://pano.mappls.com/realview_widget/sample/index.php?token=6xxxxxx4-9xxx-xxx7-xxxb-8dxxa7xxxdc](https://pano.mappls.com/realview_widget/sample/index.php?token=6xxxxxx4-9xxx-xxx7-xxxb-8dxxa7xxxdc)

To learn more on how to create your authorization tokens, please use our authorization token URL. More details available [here](https://auth.mappls.com/console).
